...
const timeSlots = ["8:00 - 9:30", "9:45 - 11:15", "11:30 - 1:00", "1:15 - 2:45", "3:00 - 4:30", "4:45 - 6:15"]
    ...
    <div>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => handleSelectChange("day_of_the_week", value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => handleSelectChange("time_period", value)}
              >
                <SelectTrigger>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleEditConstraint}>Save Changes</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <div className="py-4">
            <p>Are you sure you want to delete this time constraint?</p>
            {selectedConstraint && (

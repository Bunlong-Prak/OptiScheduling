...
const majorGroups = [
  ...
  { id: "MIS1", name: "Management Information Systems Year 1", color: "bg-gray-100" },
  ...
  { id: "BUS1", name: "Business Administration Year 1", color: "bg-gray-100" },
  { id: "ITL1", name: "International Tourism & Hospitality Year 1", color: "bg-gray-100" },
  ...
  { id: "BUS2", name: "Business Administration Year 2", color: "bg-gray-100" },
  { id: "ITL2", name: "International Tourism & Hospitality Year 2", color: "bg-gray-100" },
  ...
  { id: "MIS3", name: "Management Information Systems Year 3", color: "bg-gray-100" },
  ...
  { id: "BUS3", name: "Business Administration Year 3", color: "bg-gray-100" },
]

// Mock course data with duration
const courses = [
  { id: "ENGL101", name: "English 101", color: "bg-blue-200", duration: 1, instructor: "Dr. Smith", room: "A101" },
  { id: "MATH131", name: "Mathematics 131", color: "bg-red-200", duration: 2, instructor: "Dr. Johnson", room: "B202" },
  {
    id: "CS125",
  ...
  { id: "ECON102", name: "Economics 102", color: "bg-yellow-200", duration: 1, instructor: "Dr. Brown", room: "D404" },
  { id: "PHYS101", name: "Physics 101", color: "bg-purple-200", duration: 2, instructor: "Prof. Davis", room: "E505" },
  { id: "BUS110", name: "Business 110", color: "bg-orange-200", duration: 1, instructor: "Dr. Miller", room: "F606" },
  {
    id: "ARC101",
...
export function TimetableView() {
  ...
  const handleDrop = (day: string, majorId: string, timeSlot: string) => {
    ...
    // Add the course to all its time slots
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {majorGroups.map((group) => (
                  <tr key={group.id}>
                    <td className={`px-4 py-2 whitespace-nowrap text-sm font-medium ${group.color} border`}>
                      {group.id}
                    </td>
                    {days.map((day) =>
                      timeSlots.map((time) => {
                        ...
                        return (
                          <td
                            ...
                            onDrop={() => handleDrop(day, group.id, time)}
                          >
                            {course ? (
                              <div
                                className={`${course.color} p-1 rounded cursor-pointer text-center`}
                                onClick={() => handleCourseClick(day, group.id, time, course)}
                              >
                                {course.id}
                              </div>
                            ) : (
          ...
          {selectedCourse && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">Duration: {selectedCourse.duration} hour(s)</p>
                <p className="text-sm text-gray-600">Instructor: {selectedCourse.instructor}</p>
                <p className="text-sm text-gray-600">Room: {selectedCourse.room}</p>
              </div>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove this course from the timetable?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
